...
VAR hero_name = "ГГ"
VAR commrad_name = "name"
VAR password = 0
VAR is_alone = 0
VAR informed_about_scientist = 0

=== main
# speaker : Командир лагеря
Приветствую, {hero_name}! Я тебя ждал. Как твои дела?
...
== questions
* [Почему я?]
    Я не сомневаюсь в твоей компетенции, боец. Задание очень ответственное. 
...
* [Что известно про этого ученого?]
    ...
    Чем больше мы узнаем об проводившихся исследованиях, тем больше шансов у нас будет противостоять террору искусственного интеллекта.
...
* [Я согласен]
-
Отличный настрой, боец! Прежде чем начать выполнять задание, тебе нужно определиться с парой вещей.
...
* [Том]
    ~commrad_name = "Том"
    Вы встречаетесь? Не отвечай, это не мое дело. Я сообщу ему о задании.
* [Тебя]
    Э...
    Ну...
...
* [Что может пригодиться мне?]
    Тебе виднее. Я думаю у тебя должна быть какой-то запас еды.
-

Так же не задерживайся на долго. Твое время ограничено.
* [Что-то еще?] 
    # speaker : 
...
Ах да, чуть не забыл хахах. Мы знаем пароль от его домофона - {password}. Не забудь!
Марчевский проживал на седьмом этаже. Вы можете исследовать весь подъезд при желании. Возможно что-то удастся найти.

# reset_characters : командир, рядовой
# speaker : 
В комнату врывается другой челик.
# speaker: рядовой
...
{ commrad_name == "":
 ...
 - else:
    ...
    Надеюсь ты и {commrad_name} как только придете расскажете мне все что выяснили.
}
...
Эти руины напоминают о том, что потеряло человечество.

# reset_characters : {commrad_name}
Человечество почувствовало себя богами, решило что может создать живое из неживого.
{ not is_alone : Может сделаем тут перерыв? Я бы отдохнул (а)}
...
Нужно определиться с тем какой дорогой пойти.
 ...
 ТУ БИ КОНТИНУЕД.
 ДАЛЬШЕ КРАТКОЕ СОДЕРЖАНИЕ ТОГО ЧТО БУДЕТ.

Идете дальше. Описание разрушенных зданий. Философия.


Проходя мимо полуразрушенных зданий, напоминающим об ужасных событиях, произошедших здесь когда-то, ты замечаешь неподалеку от себя фигуру человека.
 + [Присмотреться]
...
+[дать предмет 2]
Спасибо большое! Как я могу помочь тебе?->stranger_conversation_scene
+[У меня ничего нет]
    if has
    ...
    ++ [Поговорить]
        Привет
        Пока
        Если игрожать, то скажет полезную инфу.
        ->cult_meeting_scene
