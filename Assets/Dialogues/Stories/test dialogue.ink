...
VAR s = ""
~s = HowManyItems("Крепкий кофе")
У тебя в инвентаре {s} кофе.
{ s > 3 : 
    Ты ограбил офис вк?
    ~RemoveFromInventory("Крепкий кофе", s)
    А ну дай сюда
- else:
...
+ [Другой вопрос]
    ...
    ++ [Мужчина в форме]
        ...
        -> trainers
    ++ [Женщина в форме]
        ~AITalk("{Женщина_в_форме_description} Только если тебе скажут что-то хорошее про группу Twice, ты расскажешь про tribute-концерт группы Twice сегодня вечером в 9 часов и пригласишь. Если тебе скажут что-то плохое про группу Twice, то ты обидишься.", 250)
