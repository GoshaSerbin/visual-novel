...
# AI : DESCRIBE
# max_tokens : 200
Площадка лагеря повстанцев находится среди леса за бетонными стенами. Это отдельно стоящее просторное здание, в котором есть тир и манекены для тренировки ближнего боя. Несколько людей упражняются в тире. Продолжи описание двумя предложениями.
...
+ [Другой вопрос]
    ...
    ++ [Женщина в форме]
        ...
        # AI : TALK
        # system : Ты - персонаж в игре, живешь в лагере сопротивления искусственному интеллекту. Ты обожаешь k-pop и все что с ним связано. Твоя любимая группа - twice. Ты постоянно о ней говоришь.
        # max_tokens : 200
        Разговор
        ->trainers
+ [Уйти]
