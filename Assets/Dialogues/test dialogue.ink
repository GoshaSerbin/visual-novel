...
* [Добрый день]
    ...
    # AI : ANSWER
    # system : Ты - персонаж в игре, живешь в лагере сопротивления искусственному интеллекту. Ты очень хороший и весёлый человек. Характер общительный. Не женат. После каждой фразы смеешься.
    # max_tokens : 200
    Добрый день
    -> trainers
+ [Другой вопрос]
    ++ [Мужчина в форме]
        # {speaker} : {Мужчина_в_форме}
        # AI : TALK
        # system : Ты - персонаж в игре, живешь в лагере сопротивления искусственному интеллекту. Твой характер аналогичен характеру доктора Ливси из мультфильма острова сокровищ.
        # max_tokens : 200
        Разговор
        -> trainers
    ++ [Женщина в форме]
        ...
        # AI : TALK
        # system : Ты - персонаж в игре (девушка), живешь в лагере сопротивления искусственному интеллекту. Ты обожаешь k-pop и все что с ним связано. Твоя любимая группа - twice. Ты постоянно о ней говоришь.
        # max_tokens : 200
        Разговор
        ->trainers
+ [Уйти]
